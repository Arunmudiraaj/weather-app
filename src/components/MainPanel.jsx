...
const MainPanel = () => {
  ...
  const cardClasses =
    "flex-grow rounded-md bg-white shadow-lg border border-gray-200 border-t-4 px-6 py-4 flex flex-col justify-center items-center gap-1";

  if (Object.keys(weather).length == 0) {
    return (
      <i className="h-full flex justify-center items-center text-2xl mt-20 md:mt-0 text-center">
    ...
    <div className="p-2 flex flex-col h-full">
      <div className="flex gap-2 flex-col md:flex-row">
        ...
        <div className={`${cardClasses} border-t-blue-500`}>
          ...
          <div className="text-xl font-bold">
            {weather?.daily?.winddirection_10m_dominant?.[0]} &#176;
          </div>
        </div>
      </div>
      <div className="mt-5 flex-grow overflow-auto p-1">
